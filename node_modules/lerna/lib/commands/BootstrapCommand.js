  ...
  _createClass(BootstrapCommand, [{
    ...
    value: function initialize(callback) {
      ...
      if (npmClient === "yarn" && typeof hoist === "string") {
        return callback(new _Command2.ValidationError("EWORKSPACES", _dedent2.default`
      ...
      if (npmClient === "yarn" && this.repository.packageJson.workspaces && this.options.useWorkspaces !== true) {
        return callback(new _Command2.ValidationError("EWORKSPACES", _dedent2.default`
                ...
                if (bin) {
                  _async2.default.series(dependents.map(function (pkg) {
                    return function (cb) {
                      ...
                      _PackageUtilities2.default.createBinaryLink(src, pkg, cb);
                    };
                  }), cb);
                } else {
                  cb();
