...
var ConventionalCommitUtilities = function () {
  ...
  _createClass(ConventionalCommitUtilities, null, [{
    ...
    value: function recommendIndependentVersion(pkg, opts) {
      var args = [RECOMMEND_CLI, "-l", pkg.name, "--commit-path", pkg.location, "-p", ConventionalCommitUtilities.changelogPreset(opts)];
    ...
    value: function recommendFixedVersion(pkg, opts) {
      var args = [RECOMMEND_CLI, "--commit-path", pkg.location, "-p", ConventionalCommitUtilities.changelogPreset(opts)];
    ...
    value: function updateIndependentChangelog(pkg, opts) {
      ...
      var args = [CHANGELOG_CLI, "-l", pkg.name, "--commit-path", pkg.location, "--pkg", pkgJsonLocation, "-p", ConventionalCommitUtilities.changelogPreset(opts)];
    ...
    value: function updateFixedChangelog(pkg, opts) {
      var pkgJsonLocation = _path2.default.join(pkg.location, "package.json");
      var args = [CHANGELOG_CLI, "--commit-path", pkg.location, "--pkg", pkgJsonLocation, "-p", ConventionalCommitUtilities.changelogPreset(opts)];
    ...
    value: function updateFixedRootChangelog(pkg, opts) {
      var args = [CHANGELOG_CLI, "-p", ConventionalCommitUtilities.changelogPreset(opts), "--context", _path2.default.resolve(__dirname, "..", "lib", "ConventionalChangelogContext.js")];
    ...
    key: "changelogPreset",
    value: function changelogPreset(opts) {
