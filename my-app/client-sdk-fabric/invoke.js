    ...
    Fabric_Client.newDefaultKeyValueStore({
      ...
      .then(user_from_store => {
        if (user_from_store && user_from_store.isEnrolled()) {
          ...
          throw new Error('Failed to get ', invokeObject.argUser, ' .... run registerUser.js');
        }
        ...
        // createCar chaincode function - requires 5 invokeObject.args, ex: invokeObject.args: ['CAR12', 'Honda', 'Accord', 'Black', 'Tom'],
        // changeCarOwner chaincode function - requires 2 invokeObject.args , ex: invokeObject.args: ['CAR10', 'Dave'],
        // must send the proposal to endorsing peers
        console.log("INVIKEARGSARG_ARGS", invokeObject.argInvokeArguments);
        ...
        var request = {
          ...
          args: [JSON.stringify(invokeObject.argInvokeArguments)],
          txId: tx_id,
        };
